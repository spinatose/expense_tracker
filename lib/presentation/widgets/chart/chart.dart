...
import 'package:expense_tracker/domain/expense_bucket.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ExpenseBucket.forCategory(allExpenses: expenses, category: Category.bills),
      ExpenseBucket.forCategory(allExpenses: expenses, category: Category.food),
      ExpenseBucket.forCategory(allExpenses: expenses, category: Category.leisure),
      ExpenseBucket.forCategory(allExpenses: expenses, category: Category.other),
